...
'''
good example of list comprehension in stackoverflow - return names based on letter
https://stackoverflow.com/questions/33358173/python-list-comprehension-return-names-based-on-letter
'''

# Write a list comprehension that creates a list of names of everyone
# whose name starts with 'D':
print("Starts with D:")
# need to call first letter in h.name that only start with 'D'
a = [h.name for h in humans if h.name[0] == 'D']
# h.name[0] is to indicate first letter in name
print(a)
